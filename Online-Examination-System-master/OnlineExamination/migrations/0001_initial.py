# Generated by Django 2.1.2 on 2018-10-15 11:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam_name', models.ForeignKey(on_delete=True, to='OnlineExamination.Exams')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.AddField(
            model_name='question',
            name='section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OnlineExamination.Section'),
        ),
    ]
